...
/// 仮想キーコード。
///
/// WinForms の System.Windows.Forms.Keys と同じ名前・同じ値にしてある。
/// 設定ファイルのキー名は Enum.TryParse で解決するので、名前を合わせておかないと
/// 既存の設定が読めなくなるため。
///
/// Keys と違い [Flags] にしていない。Keys は [Flags] なので ToString() が
/// "D0, Oemtilde" のような紛らわしい表示になり、ログが読みにくかった。
/// </summary>
